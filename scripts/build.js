...
if (fs.existsSync(appServerDir)) {
  ...
  const routeMappings = [
    ...
    { src: 'cv/mohamedcv.html', dests: ['cv/mohamedcv.html', 'cv/mohamedcv/index.html'] },
...
// 4. Create Cloudflare Pages Advanced Mode _worker.js with full edge API routing & fallback
const workerContent = `
/**
...
console.log('✓ Created enhanced public/_worker.js with full edge API routing & fallback.');
