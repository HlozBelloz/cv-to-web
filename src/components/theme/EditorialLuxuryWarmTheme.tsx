...
export function EditorialLuxuryWarmTheme({ profile: initialProfile }: Props) {
  ...
  return (
    <div className="min-h-screen bg-[#faf8f5] text-[#292524] antialiased selection:bg-rose-200/60 selection:text-stone-900 font-['Plus_Jakarta_Sans',sans-serif]">
      
      {/* 1. TOP STICKY NAVBAR */}
      <nav className="sticky top-0 z-40 bg-[#faf8f5]/90 backdrop-blur-md border-b border-stone-200/80 px-4 sm:px-8 py-3.5 print:hidden">
        <div className="max-w-6xl mx-auto flex items-center justify-between gap-4">
          <div className="flex items-center gap-2.5">
            <span className="w-2.5 h-2.5 rounded-full bg-rose-500 animate-pulse" />
            <a href="#hero" className="font-['Playfair_Display',serif] text-base sm:text-lg font-bold tracking-tight text-stone-900 hover:text-rose-900 transition-colors">
              {profile.fullName}
            </a>
            <span className="hidden md:inline-block text-stone-300">|</span>
            <span className="hidden md:inline-block text-xs uppercase tracking-widest text-stone-500 font-serif font-semibold">
              Editorial Luxury Suite
            </span>
          </div>

          <div className="flex items-center gap-2 sm:gap-3">
            <div className="hidden lg:flex items-center gap-5 text-xs font-semibold text-stone-600 mr-2">
              <a href="#education" className="hover:text-stone-950 transition-colors">Academic Standing</a>
              ...
              <a href="#certifications" className="hover:text-stone-950 transition-colors">Credentials</a>
              <a href="#experience" className="hover:text-stone-950 transition-colors">Timeline</a>
            </div>
            ...
            <button
              ...
              className="hidden sm:inline-flex items-center gap-1.5 px-3 py-1.5 rounded-xl border border-stone-300 bg-white hover:bg-stone-50 text-stone-800 text-xs font-semibold transition-colors"
            >
            ...
            <button
              ...
              className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-xl border border-rose-400/40 bg-rose-50/80 hover:bg-rose-100 text-rose-900 text-xs font-bold transition-colors"
      ...
      <main className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-10 md:py-16 space-y-20">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-10 items-start">
            ...
            <div className="lg:col-span-8 space-y-6">
              ...
              <div className="flex items-center gap-2">
                <span className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full bg-rose-50 text-rose-900 text-xs font-semibold border border-rose-200">
                  <span className="w-2 h-2 rounded-full bg-rose-500 animate-pulse" />
                  {profile.availabilityStatus || 'Available for Executive & Engineering Roles'}
                </span>
              ...
              <div className="p-5 rounded-2xl bg-[#faf8f5] border border-stone-200/90 text-stone-700 text-sm leading-relaxed">
            ...
            <div className="lg:col-span-4 flex flex-col items-center sm:items-start lg:items-end">
              <div className="relative w-full max-w-[280px] aspect-[4/5] rounded-2xl overflow-hidden border border-stone-300 shadow-md bg-stone-100">
                ...
                <div className="absolute bottom-3 left-3 right-3 p-2.5 rounded-xl bg-stone-900/90 backdrop-blur-md text-white border border-white/10 shadow-lg text-center">
                  <span className="text-[10px] font-bold text-rose-300 uppercase tracking-widest block font-serif">
                    Academic Distinction
                  </span>
                  <p className="text-xs font-bold text-stone-100">
                    {profile.gpa || 'Cumulative GPA: 1.65 (A-)'}
                  </p>
                </div>
              </div>
            </div>
          ...
          <div className="flex items-center justify-between border-b border-stone-300 pb-3">
            <div className="flex items-center gap-2.5">
              ...
              <h2 className="font-['Playfair_Display',serif] text-2xl sm:text-3xl font-normal text-stone-950">
                Academic Background & GPA Standing
              </h2>
            </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-12 gap-6">
            ...
            <div className="md:col-span-4 rounded-3xl border-2 border-stone-900 bg-stone-950 text-white p-6 sm:p-7 flex flex-col justify-between shadow-lg relative overflow-hidden">
              <div className="space-y-3 relative z-10">
                <span className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full bg-rose-400/20 text-rose-300 border border-rose-400/30 text-xs font-bold uppercase tracking-wider">
                  <Award className="w-3.5 h-3.5" />
                  German Scale Honors
                </span>

                <div className="pt-2">
                  <span className="text-xs uppercase tracking-wider text-stone-400 font-semibold block">Cumulative GPA</span>
                  <div className="text-4xl sm:text-5xl font-extrabold text-rose-300 tracking-tight pt-1">
                    {profile.gpa || '1.65 (A-)'}
                  </div>
                </div>

                <p className="text-xs text-stone-300 leading-relaxed pt-1">
                  German University in Cairo (GUC). Information Engineering & Technology. High A- Standing (1.0 = Highest distinction).
                </p>
              </div>
                ...
                <div key={edu.id || idx} className="space-y-4">
                  ...
                  {edu.honors && (
                    <div className="p-3.5 rounded-xl bg-[#faf8f5] border border-stone-200 text-xs text-stone-700">
                      <strong>Honors & Distinction:</strong> {edu.honors}
                    </div>
                  )}
        ...
        <section id="capabilities" className="space-y-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div className="p-6 rounded-3xl bg-white border border-stone-300/80 shadow-xs space-y-4 hover:border-stone-400 transition-colors">
              <div className="w-12 h-12 rounded-2xl bg-rose-50 border border-rose-200 flex items-center justify-center text-rose-800">
            ...
            {filteredProjects.map((proj) => (
              ...
              >
                <div className="space-y-4">
                  ...
                  <div className="space-y-2">
                    <h3 className="text-lg font-bold text-stone-900 group-hover:text-rose-900 transition-colors flex items-center justify-between">
              ...
              >
                ...
                <div className="p-5 space-y-3 flex-1 flex flex-col justify-between">
                  <div className="space-y-1.5">
                    ...
                    <h3 className="text-sm font-bold text-stone-900 group-hover:text-rose-900 transition-colors line-clamp-2">
                      {cert.title}
                    </h3>
                  </div>
        ...
        <section id="contact" className="rounded-3xl bg-stone-900 text-white p-8 sm:p-12 shadow-xl space-y-6">
          <div className="max-w-2xl space-y-3">
            <span className="text-xs font-bold text-rose-300 uppercase tracking-widest block font-serif">
          ...
          <div className="flex flex-wrap items-center gap-3 pt-2">
            <a
              ...
              className="inline-flex items-center gap-2 px-6 py-3 rounded-xl bg-rose-400 hover:bg-rose-300 text-stone-950 font-bold text-xs shadow-lg transition-all hover:scale-[1.02]"
            >
      ...
      {/* FOOTER */}
      <footer className="border-t border-stone-300/80 bg-white py-8 px-6 text-center text-xs text-stone-500 font-serif">
      ...
      {selectedProject && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/80 backdrop-blur-xs animate-in fade-in">
          <div className="bg-white rounded-3xl max-w-xl w-full p-6 sm:p-8 space-y-5 shadow-2xl relative text-left">
            ...
            <div className="space-y-1">
              <span className="text-[11px] font-bold text-rose-800 uppercase tracking-wider block font-serif">
            ...
            {selectedProject.metrics && (
              <div className="p-3 rounded-xl bg-rose-50 border border-rose-200 text-xs font-semibold text-rose-900">
